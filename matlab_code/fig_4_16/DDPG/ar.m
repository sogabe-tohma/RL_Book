classdef ar <handle
    properties(SetAccess=public)
        a_w={unform( 2,30),unform(30,60),random('Uniform',-3e-3, 3e-3, [60,1])};
        a_b={zeros(1,30),zeros(1,60),zeros(1)};
        at_w={unform( 2,30),unform(30,60),random('Uniform',-3e-3, 3e-3, [60,1])};
        at_b={zeros(1,30),zeros(1,60),zeros(1)};
